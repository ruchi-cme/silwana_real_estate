                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" id="search" data-kt-docs-table-filter="search"
                                class="form-control form-control-solid w-250px ps-14" placeholder="Search Builder" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <!--begin::Add user-->
                            @can('builder-create')
                            <a href="{{ route('admin.builder.create') }}" class="btn btn-hover-scale btn-success">
                            <i class="fa fa-plus"></i> Add Builder</a>
                            @endcan
                            <!--end::Add user-->
                        </div>
                        <!--end::Toolbar-->
    ...
    const datatable = $("#datatable").DataTable({
        ...
        columnDefs: [{
                ...
                render: function (data, type, row) {
                    ...
                    return `
                            <a href="builder/edit/${data.id}" class="btn btn-sm btn-icon btn-hover-scale btn-active-success me-2"
                            ><span class="svg-icon svg-icon-1"><i class="fa fa-edit"></i></span></a>
                            <a href="builder/delete/${data.id}" class="btn btn-sm btn-icon btn-hover-scale btn-active-danger me-2"
                            ><span class="svg-icon svg-icon-1"><i class="fa fa-trash"></i></span></a>
                             <a href="builder/changeStatus/${data.id}" class="btn btn-sm btn-icon btn-hover-scale btn-active-primary  me-2"
