@extends('admin.layouts.main',['title' => 'Investment'])

@section('breadcrumb')
<li class="breadcrumb-item pe-3"><a href="{{ route('admin.admin') }}" class="pe-3"><i class="fa fa-home text-hover-primary"></i></a></li>
<li class="breadcrumb-item px-3 text-primary">Sales CMS</li>
<li class="breadcrumb-item px-3"><a class="text-hover-primary " href="{{ route('admin.investService') }}">Investment</a></li>
    ...
    <div id="kt_content_container" class="container-fluid">
        ...
        <div class="d-flex flex-column flex-lg-row">
            ...
            <div class="flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0">
                ...
                <form class="form" method="POST" action=" {{ !empty( $editData->id) ?  route('admin.investService.update') : route('admin.investService.store') }}" id="dataForm" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Card-->
                    <div class="card shadow-lg card-flush pt-3 mb-5 mb-lg-10">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-title">
                                <h2 class="fw-bolder">Investment</h2>
                            </div>
                            <!--begin::Card title-->
                        </div>
                        <!--end::Card header-->
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="row mb-8">
                                <!--begin::Col-->
                                <div class="col-xl-3">
                                    <div class="fs-6 fw-bold mt-2 mb-3 required"> Sub Title</div>
                                </div>
                                <!--end::Col-->
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                    <input type="text" required placeholder="Enter Sub Title" class="form-control form-control-solid" name="sub_title" value="{{ !empty( $editData->sub_title) ? $editData->sub_title : '' }}" >
                                    <div class="fv-plugins-message-container invalid-feedback"></div></div>
                            </div>
                            <!--end::Row-->
                            <!--begin::Row-->
                                ...
                                <!--begin::Col--> <div class="col-md-3 mb-3">
                                    ...
                                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: none">
                                        ...
                                        <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change image">
                                            ...
                                            <!--begin::Inputs-->
                                            <input type="file" value="{{ !empty($editData->image) ? $editData->image : '' }}" name="image" id="image" accept="image/*" onchange="validateFileType()" />
