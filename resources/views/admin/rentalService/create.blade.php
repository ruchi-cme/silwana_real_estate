@extends('admin.layouts.main',['title' => 'Rental'])
    ...
    <div id="kt_content_container" class="container-fluid">
        ...
        <div class="d-flex flex-column flex-lg-row">
            ...
            <div class="flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0">
                ...
                <form class="form" method="POST" action=" {{ !empty( $editData->id) ?  route('admin.rentalService.update') : route('admin.rentalService.store') }}" id="dataForm" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Card-->
