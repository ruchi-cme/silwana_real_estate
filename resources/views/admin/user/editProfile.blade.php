        ...
        <div class="card mb-5 mb-xl-10 shadow-lg">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form id="profile_details_form" class="form" method="post" action="{{ route('admin.user.updateProfile') }}" enctype="multipart/form-data" >
                          @csrf
                            <!--begin::Card body-->
...
@endsection
@push('scripts')<script src=" {{asset('js/custom/account/settings/signin-methods.js')}}"></script>
<script type="text/javascript">
    ...
    $("#profile_details_form").validate({
        ...
        if($('#profile_details_form').valid()  ) { console.log(2);
