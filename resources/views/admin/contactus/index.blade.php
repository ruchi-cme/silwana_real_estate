...
<li class="breadcrumb-item px-3 text-primary">Contact Us</li>
@endsection
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <!--begin::Add user-->
                            @can('contactus-create')
                            <a href="{{ route('admin.contactus.create') }}" class="btn btn-hover-scale btn-success">
    ...
    const datatable = $("#datatable").DataTable({
        ...
        columnDefs: [{
                ...
                render: function (data, type, row) {
                    ...
                    return `
                            <a href="contactus/edit/${data.id}" class="btn btn-sm btn-icon btn-hover-scale btn-active-success me-2"
                            ><span class="svg-icon svg-icon-1"><i class="fa fa-edit"></i></span></a>
                            <a href="contactus/delete/${data.id}" class="btn btn-sm btn-icon btn-hover-scale btn-active-danger me-2"
                            ><span class="svg-icon svg-icon-1"><i class="fa fa-trash"></i></span></a>
                             <a href="contactus/changeStatus/${data.id}" class="btn btn-sm btn-icon btn-hover-scale btn-active-primary  me-2"
