...
<li class="breadcrumb-item px-3"><a class="text-hover-primary " href="{{ route('admin.news') }}">News</a></li>
    ...
    <div id="kt_content_container" class="container-fluid">
        ...
        <div class="d-flex flex-column flex-lg-row">
            ...
            <div class="flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0">
                ...
                <form class="form" method="POST" action=" {{ !empty( $editData->news_id) ?  route('admin.news.update') : route('admin.news.store') }}" id="dataForm" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Card-->
                    <div class="card shadow-lg card-flush pt-3 mb-5 mb-lg-10">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="row mb-8">
                                <!--begin::Col-->
                                <div class="col-xl-3">
                                    <div class="fs-6 fw-bold mt-2 mb-3 required"> Link</div>
                                </div>
                                <!--end::Col-->
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                    <input type="text" required placeholder="Enter Link" class="form-control form-control-solid" name="link" value="{{ !empty( $editData->link) ? $editData->link : '' }}" >
                                    <div class="fv-plugins-message-container invalid-feedback"></div></div>
                            </div>
                            <!--end::Row-->
                            ...
                            <div class="row">
                                ...
                                <!--begin::Col--> <div class="col-md-3 mb-3">
                                    ...
                                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: none">
                                        ...
                                        @php
                                            $path =  !empty($editData->image) ? asset('images/news' ).'/'.$editData->image : ''  ;
                            ...
                            <div class="row text-center">
                                <input type="hidden" name="id" value="{{ !empty( $editData->news_id) ? $editData->news_id : '' }}" id="news_id">
                                <!--begin::Col-->
                                <!--begin::Actions-->
                                <div class="mb-0">
                                    <button type="button" data-form="amenityForm" class="btn btn-primary" id="create_button">
                                        <!--begin::Indicator-->
                                        <span class="indicator-label">{{ !empty( $editData->news_id) ?  'Update' : 'Create' }}  News</span>
