        ...
        <td>
            <div class="main-div" style="width: 100%;max-width: 500px;height: auto;position: relative; margin-left: 70px; border-radius: 10px;background-color: #fff;z-index: 10; box-shadow: 0px 20px 50px rgba(0, 0, 0, 0.1);" >
                <div class="top-icon" style="position: relative;margin-top: 10px;margin-bottom: 30px; padding-top: 22px;">
                    ...
                    <div class="one-time-password" style="width: 100%; max-width: 288px;height: auto;padding:30px 40px 30px 40px; border: 2px dashed #B48D4E; border-radius: 2px; margin: 0px auto ;margin-top: 30px !important;margin-bottom: 57px !important;  box-sizing: border-box;text-align: center;">
                ...
                <div class="extra-text" style="height: auto;padding: 10px 50px 10px 50px; background-color: #B48D4E;border-radius: 0px 0px 10px 10px;">
