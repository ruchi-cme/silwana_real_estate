                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-10">
                                <div class="profile-detail">
                                    ...
                                    <div>
                                        <button type="button" class="cmn-btn edit-profile-btn" data-bs-toggle="modal" data-bs-target="#exampleModal">EDIT PROFILE <img src="{{ asset('images/front') }}/edit.svg" alt=""> </button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        <form  action="{{route('myProfile/update')}}" method="post" class="edit-profile-form" id="profileModal" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
